...
// // // This will trigger the watcher and log stack trace
// // testObj.name = 'Jane'
// // testObj.address.street = '456 Oak Ave'
// // testObj.address.coordinates.lat = 42.3602
// // testObj.hobbies.push('swimming')
// // testObj.hobbies[0] = 'writing'

// // // GET HACKED 👿😈👹👹👽👽👽🤖🤖🤖👾👾👾👻👻👻💀
// // window.todos[0].name = 'HAHA!!! I hack you!!! Your computa belong to M;EMEEEEE NOWWW, HAHAHAHA'
// // // GET HACKED LOOOL 👿😈👹👹👽👽👽🤖🤖🤖👾👾👾👻👻👻💀

import { createApp } from 'vue'
import Main from './src/Main.vue'

// function watchObjectDeep<T extends object>(target: T): void {
//   // Create a proxy that intercepts property access and mutations
//   const createProxy = (obj: any, currentPath: string): any => {
//     return new Proxy(obj, {
//       set(target, property, value, receiver) {
//         const propertyPath = currentPath ? `${currentPath}.${String(property)}` : String(property)

//         // Capture stack trace
//         const stack = new Error().stack

//         // Log the change with stack trace
//         console.log(`🔄 Property changed: ${propertyPath}`)
...
//         // If the new value is an object, make it watchable too
//         if (value && typeof value === 'object' && !Array.isArray(value)) {
//           target[property] = createProxy(value, propertyPath)
//         }
//         else if (Array.isArray(value)) {
//           target[property] = createArrayProxy(value, propertyPath)
//         }
...
//         // If accessing an object property that isn't already proxied, proxy it
...
//   // Special handling for arrays to watch push, pop, etc.
//   const createArrayProxy = (arr: any[], currentPath: string): any[] => {
//     return new Proxy(arr, {
//       set(target, property, value, receiver) {
//         const propertyPath = `${currentPath}[${String(property)}]`

//         // Only log for numeric indices and length changes
//         if (!isNaN(Number(property)) || property === 'length') {
//           const stack = new Error().stack
//           console.log(`🔄 Array changed: ${propertyPath}`)
//           console.log(`   Old value:`, target[property])
//           console.log(`   New value:`, value)
//           console.log(`   Stack trace:`)
//           console.log(stack)
...
//         // Proxy array methods that modify the array
//         if (typeof value === 'function' && ['push', 'pop', 'shift', 'unshift', 'splice', 'sort', 'reverse'].includes(String(property))) {
//           return function (...args: any[]) {
//             const stack = new Error().stack
//             console.log(`🔄 Array method called: ${currentPath}.${String(property)}(${args.map(a => JSON.stringify(a)).join(', ')})`)
//             console.log(`   Stack trace:`)
//             console.log(stack)
//             console.log('---')
...
//             // Re-proxy any new objects added to the array
//             if (['push', 'unshift', 'splice'].includes(String(property))) {
//               for (let i = 0; i < target.length; i++) {
//                 if (target[i] && typeof target[i] === 'object' && !isProxy(target[i])) {
//                   if (Array.isArray(target[i])) {
//                     target[i] = createArrayProxy(target[i], `${currentPath}[${i}]`)
//                   }
//                   else {
...
//         && Object.getOwnPropertyDescriptor(obj, '__isProxy__')?.value === true
//     }
//     catch {
//       return false
//     }
...
//   // Recursively proxy all nested objects and arrays
//   const proxyNestedObjects = (obj: any, currentPath: string): void => {
...
//         if (Array.isArray(value)) {
//           obj[key] = createArrayProxy(value, propertyPath)
//         }
//         else if (value && typeof value === 'object') {
//           obj[key] = createProxy(value, propertyPath)
//         }
//       }
//     }
//   }

//   proxyNestedObjects(target, '')

//   const proxiedTarget = createProxy(target, '')
//   Object.setPrototypeOf(target, Object.getPrototypeOf(proxiedTarget))
//   Object.keys(proxiedTarget).forEach((key) => {
//     (target as any)[key] = (proxiedTarget as any)[key]
//   })
// }
...
//     watchEffect(() => {
//       const stack = new Error('.').stack
//       console.log(`🔄 Value changed to`, target)
//       console.log(stack)
//       console.log('---')
//     })
//     return target
...
//     watchObjectDeep(target as T & object)
//     return target
//   }
...
// function monkey<N extends object, T extends keyof N>(namespace: N, prop: T): void {
//   if (typeof namespace[prop] !== 'function')
//     return

//   const originalPush = namespace[prop].bind(namespace)
//   namespace[prop] = function (...args: any[]) {
//     const stack = new Error('.').stack
